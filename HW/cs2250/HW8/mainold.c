    ...
    while(menuOp != 'q') 
    {
        ...
        switch (menuOp) 
        {
            ...
            case 'c':
                ...
                {
                    prevNode = songNode;//parent of song node
                ...
                while( count < newPosition )
                {
                    ...
                    {
                        //NEw song is new code!!!!
                        newSong = insertPosNode; //Parent of insertPosNode
                ...
                else 
                {
                    ...
                    else 
                    {
                        ...
                        else
                        {
                            ...
                            newSong->nextNodePtr = insertPosNode;
                            //SetNextPlaylistNode(insertPosNode,songNode);
                            // .....
                        }
